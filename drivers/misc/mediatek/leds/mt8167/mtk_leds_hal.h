...
extern int mt_cust_set_led_brightness(enum mt65xx_led_cust cus_type, u32 level);
extern int mt_cust_set_led_blink(enum mt65xx_led_cust cus_type, struct nled_setting *led);
