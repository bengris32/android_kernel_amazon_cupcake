...
#define TEMPERATURE	0X90
#define TEMPERATURE_IOCTL_INIT	_IO(TEMPERATURE, 0x01)
#define TEMPERATURE_GET_DATA	_IOR(TEMPERATURE, 0x02, int)
#define TEMPERATURE_IOCTL_READ_CHIPINFO	_IOR(TEMPERATURE, 0x03, int)
