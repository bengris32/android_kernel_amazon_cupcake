...
BTS_TEMPERATURE BTS_Temperature_Table[NTC_TABLE_SIZE] = {
	{0, 0},
	{0, 0},
	{0, 0},
	{0, 0},
...
/* AP_NTC_BL197 */
BTS_TEMPERATURE BTS_Temperature_Table1[NTC_TABLE_SIZE] = {
	{-40, 74354},		/* FIX_ME */
	{-35, 74354},		/* FIX_ME */
	{-30, 74354},		/* FIX_ME */
	{-25, 74354},		/* FIX_ME */
...
/* AP_NTC_TSM_1 */
BTS_TEMPERATURE BTS_Temperature_Table2[NTC_TABLE_SIZE] = {
	{-40, 70603},		/* FIX_ME */
	{-35, 70603},		/* FIX_ME */
	{-30, 70603},		/* FIX_ME */
	{-25, 70603},		/* FIX_ME */
...
/* AP_NTC_10_SEN_1 */
BTS_TEMPERATURE BTS_Temperature_Table3[NTC_TABLE_SIZE] = {
	{-40, 74354},		/* FIX_ME */
	{-35, 74354},		/* FIX_ME */
	{-30, 74354},		/* FIX_ME */
	{-25, 74354},		/* FIX_ME */
...
BTS_TEMPERATURE BTS_Temperature_Table4[NTC_TABLE_SIZE] = {
	{-40, 188500},
	{-35, 144290},
	{-30, 111330},
	{-25, 86560},
...
/* AP_NTC_47 */
BTS_TEMPERATURE BTS_Temperature_Table5[NTC_TABLE_SIZE] = {
	{-40, 483954},		/* FIX_ME */
	{-35, 483954},		/* FIX_ME */
	{-30, 483954},		/* FIX_ME */
	{-25, 483954},		/* FIX_ME */
...
/* NTCG104EF104F(100K) */
BTS_TEMPERATURE BTS_Temperature_Table6[NTC_TABLE_SIZE] = {
	{-40, 4251000},
	{-35, 3005000},
	{-30, 2149000},
	{-25, 1554000},
...
BTS_TEMPERATURE BTS_Temperature_Table7[NTC_TABLE_SIZE] = {
	{-40, 4397119},
	{-35, 3088599},
	{-30, 2197225},
	{-25, 1581881},
...
/* NCP15XH103(10K) */
BTS_TEMPERATURE BTS_Temperature_Table8[NTC_TABLE_SIZE] = {
	{-40, 195652},
	{-35, 148171},
	{-30, 113347},
	{-25, 87559},
...
BTS_TEMPERATURE BTS_Temperature_Table9[NTC_TABLE_SIZE] = {
	{-40, 4397119},
	{-35, 3088599},
	{-30, 2197225},
	{-25, 1581881},
...
void mtkts_bts_prepare_table(int table_num)
{
	...
	case 7:		/* NCP15WF104F03RC */
		...
		break;
	case 8:		/* NCP15XH103 */
		mtkts_bts_copy_table(BTS_Temperature_Table, BTS_Temperature_Table8);
		WARN_ON_ONCE(sizeof(BTS_Temperature_Table) != sizeof(BTS_Temperature_Table8));
		break;
	case 9:		/* NCP03WF104F05RL */
		mtkts_bts_copy_table(BTS_Temperature_Table, BTS_Temperature_Table9);
		WARN_ON_ONCE(sizeof(BTS_Temperature_Table) != sizeof(BTS_Temperature_Table9));
		break;
	default:		/* AP_NTC_10 */
		mtkts_bts_copy_table(BTS_Temperature_Table, BTS_Temperature_Table4);
		WARN_ON_ONCE(sizeof(BTS_Temperature_Table) != sizeof(BTS_Temperature_Table4));
