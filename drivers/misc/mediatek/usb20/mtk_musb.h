...
extern int mt_usb_otg_init(struct musb *musb);
extern int mt_usb_init_drvvbus(void);
...
static inline bool mt_usb_otg_supported(void) { return true; };
#else
static inline int mt_usb_otg_init(struct musb *musb) { return 0; }
static inline int mt_usb_init_drvvbus(void) { return 0; }
static inline void mt_usb_set_vbus(struct musb *musb, int is_on) { }
static inline int mt_usb_get_vbus_status(struct musb *musb) { return 1; }
static inline void switch_int_to_device(struct musb *musb) { }
static inline void switch_int_to_host(struct musb *musb) { }
static inline void switch_int_to_host_and_mask(struct musb *musb) { }
static inline void musb_session_restart(struct musb *musb) { }
static inline bool mt_usb_otg_supported(void) { return false; }
#endif
