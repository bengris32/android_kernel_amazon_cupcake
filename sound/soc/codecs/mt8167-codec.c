...
static int mt8167_codec_hp_calibration_info(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_info *uinfo)
{
...
static int mt8167_codec_hp_calibration_put(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mt8167_codec_priv *codec_data =
	...
	if (codec_data->internal_dac_disable) {
...
static const struct snd_kcontrol_new mt8167_codec_controls[] = {
	...
	/* HP Calibration */
	MT8167_CODEC_CONTROL("HP Calibration",
		mt8167_codec_hp_calibration_info,
		NULL,
		mt8167_codec_hp_calibration_put),
	/* Uplink LR Swap */
		...
		struct mt8167_codec_priv *codec_data)
{
	...
	if (!self_node) {
		...
		codec_data->internal_dac_disable = true;
		return NULL;
	}
