...
#define AIC31XX_FREQ_4096000 4096000
#define AIC31XX_FREQ_2048000 2048000
#define AIC31XX_FREQ_6144000 6144000
...
struct aic31xx_priv {
	...
	u32 fmt;
	u32 bclk_ratio;
	struct workqueue_struct *enable_wq;
	struct work_struct nadc_enable_work;
