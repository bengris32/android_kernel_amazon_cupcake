...
enum {
	MT8167_AFE_CLK_ONDEMAND = 0,
	MT8167_AFE_CLK_ONALWAYS,
};

enum {
	MT8167_AFE_BUS_I2S0 = 0,
	MT8167_AFE_BUS_I2S1,
	MT8167_AFE_BUS_I2S2,
	MT8167_AFE_BUS_I2S3,
	MT8167_AFE_BUS_TDM_OUT,
	MT8167_AFE_BUS_TDM_IN,
	MT8167_AFE_BUS_NUM,
};
...
struct mtk_afe {
	...
	unsigned int bus_mclk_modes[MT8167_AFE_BUS_NUM + 1];
	unsigned int bus_blrclk_modes[MT8167_AFE_BUS_NUM];
	unsigned int bus_bclk_factors[MT8167_AFE_BUS_NUM];
	unsigned int bus_l_r_swap[MT8167_AFE_BUS_NUM];
...
#endif
	unsigned int i2s1and2_mclk_double_rate;
};
